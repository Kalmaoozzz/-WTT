...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-03-2024 a las 02:44:15
...
--
-- Estructura de tabla para la tabla `logears`
--

CREATE TABLE `logears` (
...
--
-- Volcado de datos para la tabla `logears`
--

INSERT INTO `logears` (`pk_id_us`, `fk_correo_us`, `usuario_us`, `clave`) VALUES
...
(3, '2024_03_06_163000_create_admin_table', 2);
...
INSERT INTO `usuarios` (`id`, `nom1_us`, `nom2_us`, `ape1_us`, `ape2_us`, `tel_us`, `correo_us`, `id_estado_us`, `pk_fk_tdoc`) VALUES
...
(16, 'kaleth', 'lance', 'torres', 'bonilla', 23444, 'kal@gmail.com', '1', 'CC'),
(18, 'kaleth', 'lance', 'torres', 'bonilla', 23444, 'ka222l@gmail.com', '1', 'TI');
...
--
ALTER TABLE `gerente`
  ADD CONSTRAINT `gerente_ibfk_1` FOREIGN KEY (`tdoc_geren`,`id_geren`) REFERENCES `usuarios` (`pk_fk_tdoc`, `id`);

--
-- Filtros para la tabla `logears`
--
ALTER TABLE `logears`
  ADD CONSTRAINT `logears_ibfk_1` FOREIGN KEY (`pk_id_us`) REFERENCES `usuarios` (`id`);
...
--
ALTER TABLE `trabajador`
  ADD CONSTRAINT `trabajador_ibfk_1` FOREIGN KEY (`tdoc_trab`,`id_trab`) REFERENCES `usuarios` (`pk_fk_tdoc`, `id`);
...
--
ALTER TABLE `usuario_has_estado`
  ADD CONSTRAINT `usuario_has_estado_ibfk_1` FOREIGN KEY (`ues_id_us`,`ues_tdoc_us`) REFERENCES `usuarios` (`id`, `pk_fk_tdoc`),
